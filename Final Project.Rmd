...
#### After processing, the histogram shows that the data approximately follows a normal distribution.
...
Use plot and regression line to display the fitting of the linear model.
```{r,warning = F, message = F}
